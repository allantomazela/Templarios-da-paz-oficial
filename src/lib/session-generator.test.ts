...
describe('summarizeAutoGeneratedBatches', () => {
  it('agrupa sessões por lote e resume período e quantidade', () => {
    const events: Event[] = [
      {
        id: '1',
        title: 'S',
    ...
    const batches = summarizeAutoGeneratedBatches(events)
...
describe('mergeBatchSummariesWithAudit', () => {
  it('combina resumo de eventos com metadados de auditoria do lote', () => {
    const events: Event[] = [
      {
        id: '1',
        title: 'S',
