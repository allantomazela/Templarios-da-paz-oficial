          ...
          <div className="px-6 pt-2">
            <TabsList className="grid w-full grid-cols-3">
              <TabsTrigger value="details">
                <Info className="h-4 w-4 mr-2 hidden sm:block" /> Detalhes
              </TabsTrigger>
              <TabsTrigger value="checkin" disabled={isMilestone}>
                <CalendarCheck className="h-4 w-4 mr-2 hidden sm:block" />{' '}
                Check-in
              </TabsTrigger>
              <TabsTrigger value="notify" disabled={isMilestone}>
                <Mail className="h-4 w-4 mr-2 hidden sm:block" /> Notificar
              </TabsTrigger>
            </TabsList>
          </div>
          ...
          >
            <ScrollArea className="flex-1 p-6">
              <div className="space-y-6 pb-6">
                {!isMilestone && <CalendarExportButtons event={event} />}
